...
with(HH_power_data_2,{
  plot(y=Global_active_power,x=DateTime,ylab ="Global Active Power (kilowatts)",xlab = "",type = "l")
  plot(y=Voltage,x=DateTime,ylab ="Voltage",xlab = "datetime",type = "l")
  plot(y=Sub_metering_1,x=DateTime,ylab ="Energy sub metering",xlab = "",type = "l")
lines(y=Sub_metering_2,x=DateTime,col ="red")
lines(y=Sub_metering_3,x=DateTime,col ="blue")
legend("topright",col=c("black","red","blue"),legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=1)
  plot(y=Global_reactive_power,x=DateTime,xlab = "datetime",type = "l")
})
